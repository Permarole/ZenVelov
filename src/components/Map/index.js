...
import { KeyrusIcon, getIcon } from "../../function/customMarker";
import {
  MapContainer,
  TileLayer,
  Marker,
    ...
    <div>
      ...
      <div id="map">
        <MapContainer center={KEYRUS_COOR} zoom={13}>
          ...
          <Marker position={KEYRUS_COOR} icon={KeyrusIcon}>
            <Popup>{"Keyrus"}</Popup>
          </Marker>
          {relevantStations &&
      ...
      <div className="legends">
        ...
        <div className="legend">
          <img
            src="marker-yellow.png"
            alt="Marqueur aucun dock"
            className="legendMarker"
          />
          Aucun dock libre
        </div>
